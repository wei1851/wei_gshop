<template>
    <div class="shop-header" >
        ...
        <div class="shop-content" @click="showIntroduction">
          <img class="content-image" :src="info?info.avatar:''">
          ...
          <div class="shop-header-discounts" v-if="info.supports" @click="showDiscount">
            <div class="discounts-left">
              <div class="activity" :class="activeType[info.supports[0].type]">
                <span class="content-tag">
        ...
        <div class="shop-brief-modal" v-if="Introduction">
          ...
          <div class="mask-footer">
            <span class="iconfont icon-close" @click="Introduction=false"></span>
          </div>
          </div>
          <div class="brief-modal-cover"></div>
        </div>

        <div class="activity-sheet" v-if="discount">
          <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">优惠活动</h2>
          <ul class="list">
            <li class="activity-item" :class="activeType[support.type]" v-for="(support,index) in info.supports" :key="index">
            <span class="content-tag">
          ...
          <div class="activity-sheet-close" @click="discount=false">
